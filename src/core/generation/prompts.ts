...
export const EXTRACT_ROLE_TASK = [
  ...
  "",
  "Each requirement must be one self-contained, testable capability.",
  "",
  "Split a sentence that demands several things at once. \"Go, Kubernetes and",
  'Postgres" is three requirements, because the employer wants all three.',
  "",
  "Never split a choice between alternatives. \"Go or Rust\" is ONE requirement,",
  'written as "Production services in Go or Rust", because a candidate who has',
  "either one satisfies the posting. Splitting it would invent an obligation the",
  "employer never stated. The same applies to \"Postgres or ClickHouse\" and to",
  'any "one of", "either", or "such as" list.',
  "",
  'When the posting names a general need and a preferred specific ("a message',
  'broker, ideally Kafka"), the general need is the requirement and the',
  "preference is a separate nice-to-have.",
  "",
  "Do not assign ids; they are added afterwards.",
  "",
